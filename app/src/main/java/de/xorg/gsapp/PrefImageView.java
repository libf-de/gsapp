...
public class PrefImageView extends ImageView {
    ...
    public PrefImageView(Context context) {
        this(context, null);
    }
    public PrefImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public PrefImageView(Context context, AttributeSet attrs, int defStyleAttr) {
