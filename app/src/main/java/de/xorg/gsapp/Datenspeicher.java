...
public class Datenspeicher {
	...
	static boolean savePassword(String pass, Context ct) {
	    try {
	    	if(pass.equals("")) {
	...
	static String getPassword(Context ct) {
	    try {
	        DESKeySpec keySpec = new DESKeySpec("".getBytes("UTF8"));
	        SecretKeyFactory keyFactory = SecretKeyFactory.getInstance("DES");
	        SecretKey key = keyFactory.generateSecret(keySpec);
	        ...
	        if(epass.equals("")) {
		        ...
		        if(decrypedValue.startsWith("0CB0")) {
					return decrypedValue.replaceFirst("0CB0", "");
		        } else {
		        	return "error:nocb";
		        }
	        }
	...
	static void saveUser(String user, Context ct) {
		Editor editor = PreferenceManager.getDefaultSharedPreferences(ct).edit();
	    editor.putString("EssenUsername", user);
        editor.apply();
	}
	
	static String getUser(Context ct) {
