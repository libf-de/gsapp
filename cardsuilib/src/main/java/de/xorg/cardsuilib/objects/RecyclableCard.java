...
public abstract class RecyclableCard extends Card {
    ...
    public RecyclableCard(String titlePlay, String description, int imageRes,
        ...
        super(titlePlay, description, imageRes, titleColor, hasOverflow, isClickable, isDark);
    }
    ...
    public RecyclableCard(String titlePlay, String description, String color,
                          String titleColor, Boolean hasOverflow, Boolean isClickable, Boolean isDark) {
        super(titlePlay, description, color, titleColor, hasOverflow, isClickable, isDark);
    }
